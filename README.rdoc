...
It will analyze your database and create a model.yml file for use in RestfulX scaffolding
via the [./script/generate my_rx_scaffold] command.  This is also very useful for
...
will generate.  More templates coming soon!
